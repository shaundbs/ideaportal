...
urlpatterns = [
    ...
    path('challenge-history/ideas/accepted/<int:pk>', views.IdeaListAccepted.as_view(), name='accepted_ideas'),
    path('challenge-history/ideas/in-development/<int:pk>', views.IdeaListInDev.as_view(), name='in_dev_ideas'),
    path('challenge-history/ideas/delivered/<int:pk>', views.IdeaListDelivered.as_view(), name='delivered_ideas'),
    path('<slug:slug>/challenge-history/', views.History.as_view(), name='challenge_history'),
    path('challenge-history/lifecycle/<int:pk>', views.lifecycle, name='lifecycle'),
